...
var
  ...
  begin
    ...
    else if SameText('=', Token) or SameText('!=', Token) or SameText('<>', Token) or SameText('<', Token) or SameText('<=', Token) or SameText('>', Token)
      or SameText('>=', Token) then
